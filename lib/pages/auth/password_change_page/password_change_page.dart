...
class PassswordChangePage extends StatefulWidget {
  PassswordChangePage(
      // {
  ...
  @override
  _PassswordChangePage createState() => _PassswordChangePage();
}

class _PassswordChangePage extends State<PassswordChangePage> {
  final _formKey = new GlobalKey<FormState>();

  String _passwordOld;
  String _passwordNew;
  String _passwordNewConfirm;
  // String _password;
  ...
  Widget showMessage() {
    ...
    return Container(
      ...
      child: new Column(
        children: <Widget>[
          new Text(
            '¿Olvidaste tu contraseña? Ingrese su dirección de correo electrónico que fué registrado en el sistema Lamb School.',
  ...
  Widget showPasswordOld() {
    return Container(
      ...
      child: new TextFormField(
        ...
        onSaved: (value) => _passwordOld = value.trim(),
      ),
    );
  }

   Widget showPasswordNew() {
    return Container(
      margin: EdgeInsets.fromLTRB(0.0, 12.5, 0.0, 0.0),
      width: MediaQuery.of(context).size.width / 1.5,
      child: new TextFormField(
        ...
        validator: (value) => value.isEmpty ? 'No puede estar vacío.' : null,
        onSaved: (value) => _passwordNew = value.trim(),
      ),
    );
  }

   Widget showPasswordNewConfirm() {
    return Container(
      margin: EdgeInsets.fromLTRB(0.0, 12.5, 0.0, 0.0),
      width: MediaQuery.of(context).size.width / 1.5,
      child: new TextFormField(
        ...
        validator: (value) => value.isEmpty ? 'No puede estar vacío.' : null,
        onSaved: (value) => _passwordNewConfirm = value.trim(),
      ),
    );
  }
