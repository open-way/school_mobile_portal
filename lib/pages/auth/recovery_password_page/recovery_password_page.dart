...
class RecoveryPassworyPage extends StatefulWidget {
  RecoveryPassworyPage(
      // {
  ...
  @override
  _RecoveryPassworyPage createState() => _RecoveryPassworyPage();
}

class _RecoveryPassworyPage extends State<RecoveryPassworyPage> {
